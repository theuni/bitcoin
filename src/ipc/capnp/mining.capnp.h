...
public:
  ...
  inline  ::uint64_t getCoinbaseMaxAdditionalWeight() const;
...
public:
  ...
  inline  ::uint64_t getCoinbaseMaxAdditionalWeight();
  inline void setCoinbaseMaxAdditionalWeight( ::uint64_t value);
...
inline  ::uint64_t BlockCreateOptions::Reader::getCoinbaseMaxAdditionalWeight() const {
  return _reader.getDataField< ::uint64_t>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS);
}

inline  ::uint64_t BlockCreateOptions::Builder::getCoinbaseMaxAdditionalWeight() {
  return _builder.getDataField< ::uint64_t>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS);
}
inline void BlockCreateOptions::Builder::setCoinbaseMaxAdditionalWeight( ::uint64_t value) {
