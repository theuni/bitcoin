// Generated by mpgen from /home/cory/dev/bitcoin/src/ipc/capnp/mining.capnp
...
struct CoinbaseMaxAdditionalWeight
{
    template<typename S> static auto get(S&& s) -> decltype(s.getCoinbaseMaxAdditionalWeight()) { return s.getCoinbaseMaxAdditionalWeight(); }
    template<typename S> static bool has(S&& s) { return s.hasCoinbaseMaxAdditionalWeight(); }
    template<typename S, typename A> static void set(S&& s, A&& a) { s.setCoinbaseMaxAdditionalWeight(std::forward<A>(a)); }
    template<typename S, typename... A> static decltype(auto) init(S&& s, A&&... a) { return s.initCoinbaseMaxAdditionalWeight(std::forward<A>(a)...); }
    template<typename S> static bool getWant(S&& s) { return s.getWantCoinbaseMaxAdditionalWeight(); }
    template<typename S> static void setWant(S&& s) { s.setWantCoinbaseMaxAdditionalWeight(true); }
    template<typename S> static bool getHas(S&& s) { return s.getHasCoinbaseMaxAdditionalWeight(); }
    template<typename S> static void setHas(S&& s) { s.setHasCoinbaseMaxAdditionalWeight(true); }
};
...
struct ProxyStruct<ipc::capnp::messages::BlockCreateOptions>
{
    ...
    using CoinbaseMaxAdditionalWeightAccessor = Accessor<mining_fields::CoinbaseMaxAdditionalWeight, FIELD_IN | FIELD_OUT>;
    ...
    using Accessors = std::tuple<UseMempoolAccessor, CoinbaseMaxAdditionalWeightAccessor, CoinbaseOutputMaxAdditionalSigopsAccessor>;
