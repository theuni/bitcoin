...
Value encryptwallet(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return std::string("wallet encrypted; Bitcoin server stopping, restart to run with encrypted wallet. The keypool has been flushed, you need to make a new backup.");
}
