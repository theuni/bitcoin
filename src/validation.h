...
public:
    ...
    MaybeEarlyExit<> LoadMempool(bool persist);
...
private:
    ...
    friend MaybeEarlyExit<bool> node::BlockManager::LoadBlockIndex(const Consensus::Params&, ChainstateManager&);
...
public:
    ...
    std::optional<ChainstateLoadVerifyError> VerifyLoadedChainstate(bool fReset,
                                                                    bool fReindexChainState,
                                                                    const Consensus::Params& consensus_params,
