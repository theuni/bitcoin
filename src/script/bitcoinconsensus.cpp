                                    ...
                                    unsigned int nIn, unsigned int flags, bitcoinconsensus_error* err)
{
    ...
    try {
        ...
        return VerifyConsensusScript(tx.vin[nIn].scriptSig, CScript(scriptPubKey, scriptPubKey + scriptPubKeyLen), &tx.vin[nIn].scriptWitness, consensus_flags, TransactionSignatureChecker(&tx, nIn, amount, txdata), nullptr);
