...
typedef CCheckpoints::MapCheckpoints::value_type pairtype;
...
static const CCheckpoints::CCheckpointData dataRegtest = {
    ...
    CMainParams::CMainParams() {
        ...
        points.insert(pairtype( 33333, uint256S("0x000000002dd5588a74784eaa7ab0507a18ad16a236e7b1ce69f00d7ddfb5d0a6")));
        points.insert(pairtype( 74000, uint256S("0x0000000000573993a3c9e41ce34471c079dcf5f52a0e824a81e7f953b8661a20")));
        points.insert(pairtype(105000, uint256S("0x00000000000291ce28027faea320c8d2b054b2e0fe44a773f3eefb151d6bdc97")));
        points.insert(pairtype(134444, uint256S("0x00000000000005b12ffd4cd315cd34ffd4a594f430ac814c91184a0d42d2b0fe")));
        points.insert(pairtype(168000, uint256S("0x000000000000099e61ea72015e79632f216fe6cb33d7899acb35b75c8303b763")));
        points.insert(pairtype(193000, uint256S("0x000000000000059f452a5f7340de6682a977387c17010ff6e6c3bd83ca8b1317")));
        points.insert(pairtype(210000, uint256S("0x000000000000048b95347e83192f69cf0366076336c639f9b7228e9ba171342e")));
        points.insert(pairtype(216116, uint256S("0x00000000000001b4f4b433e81ee46494af945cf96014816a4e2370f11b23df4e")));
        points.insert(pairtype(225430, uint256S("0x00000000000001c108384350f74090433e7fcf79a606b8e797f065b130575932")));
 ...
 */
    CRegTestParams::CRegTestParams() {
        ...
        CCheckpoints::MapCheckpoints& points = checkpoints.checkpointData.mapCheckpoints;
        points.insert( pairtype( 0, uint256S("0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206")));
