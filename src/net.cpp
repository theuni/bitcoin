...
void StartNode(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    g_connman = std::unique_ptr<CConnman>(new CConnman(Params(), nLocalServices, PROTOCOL_VERSION, 1000*GetArg("-maxsendbuffer", DEFAULT_MAXSENDBUFFER), MAX_OUTBOUND_CONNECTIONS));
