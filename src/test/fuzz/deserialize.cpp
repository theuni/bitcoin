...
FUZZ_TARGET(netaddr_deserialize, .init = initialize_deserialize)
{
    ...
    AssertEqualAfterSerializeDeserialize(na, CNetAddr::SerParams{CNetAddr::Encoding::V2});
}
FUZZ_TARGET(service_deserialize, .init = initialize_deserialize)
{
    ...
    AssertEqualAfterSerializeDeserialize(s, CNetAddr::SerParams{CNetAddr::Encoding::V2});
...
FUZZ_TARGET(address_deserialize, .init = initialize_deserialize)
{
    ...
    if (ser_enc.enc == CNetAddr::Encoding::V1) {
        AssertEqualAfterSerializeDeserialize(a, CAddress::SerParams{{CNetAddr::Encoding::V1}, CAddress::Format::Network});
        AssertEqualAfterSerializeDeserialize(a, CAddress::SerParams{{CNetAddr::Encoding::V1}, CAddress::Format::Disk});
        AssertEqualAfterSerializeDeserialize(a, CAddress::SerParams{{CNetAddr::Encoding::V2}, CAddress::Format::Network});
        AssertEqualAfterSerializeDeserialize(a, CAddress::SerParams{{CNetAddr::Encoding::V2}, CAddress::Format::Disk});
    } else {
