...
SetupDummyInputs(CBasicKeyStore& keystoreRet, CCoinsViewCache& coinsRet)
{
    ...
    dummyTransactions[0].vout[0].scriptPubKey << CScriptBinaryData(key[0].GetPubKey()) << OP_CHECKSIG;
    dummyTransactions[0].vout[1].nValue = 50*CENT;
    dummyTransactions[0].vout[1].scriptPubKey << CScriptBinaryData(key[1].GetPubKey()) << OP_CHECKSIG;
