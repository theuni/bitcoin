...
void AddRandomOutboundPeer(NodeId& id, std::vector<std::shared_ptr<CNode>>& vNodes, PeerManager& peerLogic, ConnmanTestMsg& connman, ConnectionType connType, bool onion_peer = false)
{
    CAddress addr;
