...
#if defined(__linux__) && !defined(DISABLE_OPTIMIZED_SHA256_ARM_SHANI)
#include <sys/auxv.h>
#include <asm/hwcap.h>
#endif
...
std::string SHA256AutoDetect(sha256_implementation::UseImplementation use_implementation)
{
...
#if !defined(DISABLE_OPTIMIZED_SHA256_X86_SHANI)
    if (have_x86_shani) {
    ...
    if (have_sse4) {
        ...
        ret = "sse4(1way)";
#endif
#if !defined(DISABLE_OPTIMIZED_SHA256_SSE41)
        TransformD64_4way = sha256d64_sse41::Transform_4way;
        ret += ",sse41(4way)";
#endif
    }

#if !defined(DISABLE_OPTIMIZED_SHA256_AVX2)
...
#if !defined(DISABLE_OPTIMIZED_SHA256_ARM_SHANI)
