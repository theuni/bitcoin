...
$(package)_dependencies=openssl libpng libjpeg pcre zlib
...
$(package)_config_opts += -system-libpng -system-libjpeg -system-zlib -system-pcre -L$(host_prefix)/lib -DPCRE_STATIC
...
define $(package)_stage_cmds
  $(MAKE) -C src INSTALL_ROOT=$($(package)_destdir) $(addsuffix -install_subtargets,$(addprefix sub-,$($(package)_qt_libs))) && cd .. &&\
  $(MAKE) -C qttools/src/linguist/lrelease INSTALL_ROOT=$($(package)_destdir) install_target && \
