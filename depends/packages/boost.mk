package=boost
$(package)_version=1_46_1
$(package)_download_path=http://sourceforge.net/projects/boost/files/boost/1.46.1
$(package)_file_name=$(package)_$($(package)_version).tar.bz2
$(package)_sha256_hash=e1dfbf42b16e5015c46b98e9899c423ca4d04469cbeee05e43ea19236416d883
...
$(package)_config_libraries=filesystem,program_options,system,thread,test
...
define $(package)_build_cmds
  ./bjam -d2 -j2 -d1 --prefix=$($(package)_staging_prefix_dir) $($(package)_config_opts) stage
endef

define $(package)_stage_cmds
  ./bjam -d0 -j4 --prefix=$($(package)_staging_prefix_dir) $($(package)_config_opts) install
endef
