...
$(package)_config_opts_i386_freebsd=BSD-x86 no-asm
$(package)_config_opts_i386_openbsd=BSD-x86 no-asm
...
define $(package)_preprocess_cmds
  $(build_SED) -i.old "/define DATE/d" util/mkbuildinf.pl && \
  $(build_SED) -i.old "s|engines apps test|engines|" Makefile.org
endef
